...
#define _BANGBANG_RANGE    4000 // duty up and down for bangbang control
...
void loop()
{
  ...
  if (event_servo) {
    ...
    Serial.println(duty_current);// update servo position;
    myservo.writeMicroseconds(duty_current);
  }
...
float volt_to_distance(int a_value)
{
  ...
  return 135 + -0.748*a_value + 1.52E-03*a_value*a_value + -1.06E-06*a_value*a_value*a_value;
}
